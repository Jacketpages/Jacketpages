...
class DocumentsController extends Controller
{
	...
	public function add($id = null)
	{
		...
		$data  = array('org_id' => $id, 'name' => $this -> request -> data['Document']['submittedfile']['name'], 'path' => '', 'last_updated' => 'NOW()');
	...
	/**
	 * Fix this function later to where the file is deleted after the database entry is deleted.
	 */
	public function delete($id)
	{
		...
		if ($this -> Document -> delete($id))
		{
			...
			$this -> redirect(array('controller' => 'documents', 'action' => 'index', $org_id));
		}
