...
echo $this->Html->useTag('tagstart', 'ul', array('class'=>'menu'));
	...
	echo $this->Html->tag('li', $this->element('mainMenuBar/account'),            array('class'=>'expanded first'));
	echo $this->Html->tag('li', $this->element('mainMenuBar/bills'),              array('class'=>'expanded'));
